    ...
    <div className='container-img'>
      ...
      <div className="a-propos-text">
        ...
        <p className="paragraphe">
          ...
          technique, j'ai pu développer diverses compétences, telles que le travail
          ...
          diverse ainsi que la négociation en face-à-face avec différents
          niveaux de décideurs.
        </p>
        <p className="paragraphe">
          Ces nombreuses années, m'ont appris la curiosité, la rigueur, la
          combativité, la résilence, la détermination dans l'obtention des
          commandes.
        </p>
        <p className="paragraphe">
          Suite à une formation en distanciel avec la société OpenClassrooms sur
          une durée de 14 mois, j'ai pu réaliser de nombreux projets professionnalisants qui m'ont permis de faire croîte mes connaissances
